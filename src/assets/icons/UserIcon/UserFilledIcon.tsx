...
export default function UserFilledIcon({ active }: { active: boolean }) {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      ...
      <path
        ...
        fill={active ? tailwindColors.tertiary : tailwindColors.mainGreen}
      />
      <path
        d="M3 12C3 4.5885 4.5885 3 12 3C19.4115 3 21 4.5885 21 12C21 19.4115 19.4115 21 12 21C4.5885 21 3 19.4115 3 12Z"
        stroke={active ? tailwindColors.tertiary : tailwindColors.mainGreen}
        strokeWidth="2"
      />
      <path
