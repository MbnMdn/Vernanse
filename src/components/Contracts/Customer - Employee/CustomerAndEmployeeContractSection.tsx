...
export default function CustomerAndEmployeeContractSection({ user_role }: { user_role: string }) {
        ...
        <div className="flex flex-col gap-3 md:flex-row md:gap-6">
          <div className="flex w-full justify-between">
            <div className="flex flex-col gap-3 md:flex-row md:gap-6">
              ...
              <DatePicker onChange={onChange} placeholder="Sign Date" className="w-60" />
            </div>
