...
export default function CustomerSingleService() {
  return (
    <div className="mt-5 flex w-full items-center justify-center md:mt-10">
      <div className="grid max-w-[800px] grid-cols-1 justify-items-center gap-5 max-[900px]:grid-cols-1 max-[765px]:grid-cols-2 max-[700px]:grid-cols-1 md:gap-10 min-[1120px]:grid-cols-2	">
